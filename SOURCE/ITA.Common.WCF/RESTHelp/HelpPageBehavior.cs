...
{
    public class HelpPageBehavior : IEndpointBehavior, IHelpPageSettings, IUriHelper
    {
        ...
        {
            BaseHelpUri = DEFAULT_BASE_URI;
        }

        public HelpPageBehavior(IHelpPageSettings configuration)
        {
        ...
        public void ApplyDispatchBehavior(ServiceEndpoint endpoint, EndpointDispatcher endpointDispatcher)
        {
            ...
            if (endpointAddress.Scheme == Uri.UriSchemeHttp || endpointAddress.Scheme == Uri.UriSchemeHttps)
            {
                ...
                var helpPageUri = new Uri(address + (BaseHelpUri ?? DEFAULT_BASE_URI));
        ...
        public void Validate(ServiceEndpoint endpoint)
        {
            ...
            if (endpoint == null)
            {
                throw new WCFException(WCFException.E_REST_HELP_ENDPOINT_IS_NULL);
            }
        ...
        private void ValidateNoMessageHeadersPresent(ServiceEndpoint endpoint)
        {
            ...
            {
                throw new WCFException(WCFException.E_REST_HELP_CANNOT_HAVE_MESSAGE_HEADER,  address);
            }
        }
        ...
        private ChannelDispatcher CreateChannelDispatcher(ServiceHostBase host, ServiceEndpoint endpoint, Uri helpPageUri)
        {
            ...
            var viewResolver = new HelpViewResolver(endpoint, this);
            ...
            endpointDispatcher.ContractFilter = viewResolver;
            endpointDispatcher.AddressFilter = viewResolver;
        ...
        private static void ValidateIsWebHttpBinding(ServiceEndpoint serviceEndpoint, string behaviorName)
        {
            ...
            {
                throw new WCFException(WCFException.E_REST_HELP_INVALID_SCHEME, serviceEndpoint.Contract.Name, behaviorName);
            }
            if (binding.MessageVersion != MessageVersion.None)
            {
                throw new WCFException(WCFException.E_REST_HELP_INVALID_MESSAGE_VERSION, serviceEndpoint.Address.Uri.AbsoluteUri, behaviorName);
            }
            ...
            {
                throw new WCFException(WCFException.E_REST_HELP_NEED_MANUAL_ADDRESSING,
