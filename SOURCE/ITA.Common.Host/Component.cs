...
{
    /// <summary>
    /// Summary description for CompaundComponent.     
    /// </summary>
    public abstract class CompaundComponent : ContextBoundObject, IComponent
    {
    ...
    /// <summary>
    /// Summary description for CompaundComponentWithEvents.
    /// </summary>
    public abstract class CompaundComponentWithEvents : CompaundComponent, IComponentWithEvents
    {
    ...
    /// <summary>
    /// Summary description for ComponentWithEvents.
    /// </summary>
	public abstract class ComponentWithEvents : ContextBoundObject, IComponentWithEvents
    {
        protected ILog m_Logger;
        protected EComponentStatus m_Status = EComponentStatus.Stopped;
