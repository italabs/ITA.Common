...
namespace ITA.Common.ETWTest.Components.Services
{
    ...
    /// Static ETW provider
    /// </summary>
    [EventSource(Name = "ITA-ETWTest-MainService", LocalizationResources = "ITA.Common.ETWTest.Localization.Messages")]
    public class MainServiceEtwProvider : EventSource, IStaticEventSource
    {
        private static readonly Lazy<MainServiceEtwProvider> Instance = new Lazy<MainServiceEtwProvider>(() => new MainServiceEtwProvider());

        public static MainServiceEtwProvider Log
        {
