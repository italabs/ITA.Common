...
{    
    ...
    /// Static ETW provider
    /// </summary>
    [EventSource(Name = "ITA-ETWTest-BusinessLogic", LocalizationResources = "ITA.Common.ETWTest.Localization.Messages")]
    public class BusinessLogicEtwProvider : EventSource, IStaticEventSource
    {
        private static readonly Lazy<BusinessLogicEtwProvider> Instance = new Lazy<BusinessLogicEtwProvider>(() => new BusinessLogicEtwProvider());

        public static BusinessLogicEtwProvider Log
        {
